...
For the full list of CKV*DOCKER*\* security checks, see `references/security_checklist.md`.
...
| `security_checklist.md`    | Container security best practices; full CKV*DOCKER*\* check listings |
