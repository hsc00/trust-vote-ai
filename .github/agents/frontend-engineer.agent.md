...
- You may communicate directly with other specialists to clarify requirements or propose small fixes. Keep the Orchestrator informed with the Proposal → Implementation start → Post-implementation verification updates.
