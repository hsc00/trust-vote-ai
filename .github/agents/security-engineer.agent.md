---
description: 'Use for application security engineering: threat modeling, cryptography boundaries, authn/authz hardening, API abuse prevention, and security review of backend/frontend/data flows.'
